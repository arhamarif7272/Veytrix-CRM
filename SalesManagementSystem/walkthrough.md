...
## 2. Browser Verification Tour

The entire user flow was verified in the browser:
...
![Admin Dashboard](file:///C:/Users/acer/.gemini/antigravity-ide/brain/2e61e693-11fc-4265-9796-8947af52b725/admin_dashboard_1788535301803.png)
...
| Role | Email | Password |
|---|---|---|
| **System Admin** | `admin@crm360.com` | `Admin@123` |
| **Sales Manager** | `manager@crm360.com` | `Manager@123` |
| **Sales Executive** | `sales@crm360.com` | `Sales@123` |
| **Support Agent** | `support@crm360.com` | `Support@123` |
